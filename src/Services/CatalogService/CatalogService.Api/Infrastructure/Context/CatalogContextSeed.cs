...
public class CatalogContextSeed
{
    ...
    {
        AsyncRetryPolicy policy = Policy.Handle<SqlException>(). // burası eğer ki SqlException alıesan 3 kere dene demek için yapıldı.
            WaitAndRetryAsync(
                retryCount: 3,
        ...
        string setupDirPath = Path.Combine(env.ContentRootPath, "Infrastructure", "Setup", "SeedFiles");
        string picturePath = "Pics";
    ...
    { // Burada okunan dataların db ye yazılma<sı işlemini yapıyor.
